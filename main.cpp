...
int main(int argc, char* args[]) {
    if (!init()) {
        ...
        if (!loadMedia()) {
            ...
            Path pathEnemy4 = Path(map, TileType::PATH_ENEMY_4);
            Path pathEnemy5 = Path(map, TileType::PATH_ENEMY_5);
            Path pathEnemy6 = Path(map, TileType::PATH_ENEMY_6);
            Path pathEnemy7 = Path(map, TileType::PATH_ENEMY_7);
            ...
            Enemy enemy4 = Enemy(&gEnemyTexture, &map, &pathEnemy4, &bloodEffectCollection);
            Enemy enemy5 = Enemy(&gEnemyTexture, &map, &pathEnemy5, &bloodEffectCollection);
            Enemy enemy6 = Enemy(&gEnemyTexture, &map, &pathEnemy6, &bloodEffectCollection);
            Enemy enemy7 = Enemy(&gEnemyTexture, &map, &pathEnemy7, &bloodEffectCollection);
            std::vector<Enemy*> enemies = {&enemy1, &enemy2, &enemy3, &enemy4, &enemy5, &enemy6, &enemy7};
